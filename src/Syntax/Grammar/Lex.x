...
resWords =
  b "R" 21
    ...
    (b "match" 32
       (b "exp" 27
          (b "and" 24
             (b "]" 23 (b "[" 22 N N) N) (b "else" 26 (b "cos" 25 N N) N))
          (b "lambda" 30 (b "if" 29 (b "fst" 28 N N) N) (b "left" 31 N N)))
       (b "snd" 37
          (b "right" 35 (b "rand()" 34 (b "or" 33 N N) N) (b "sin" 36 N N))
          (b "{" 40 (b "then" 39 (b "sqrt" 38 N N) N) (b "}" 41 N N))))
  where
  b s n = B bs (TS bs n)
    where
    bs = s
